    ...
    let Modal = `<div class="modal" id="alertModal" tabindex="-1" role="dialog" aria-labelledby="alertModalLabel">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            ...
            <div class="Incident-box-header with-border" >
                ...
                <div class="modal-header col-md-12" style="display: flex;justify-content: center;align-items: flex-start;margin-top: 10px;padding-bottom: 5px !important;">
                    <div class="col-md-8">
                    <h5 class="modal-title" id="alertModalLabel" style="overflow: hidden;word-wrap: anywhere">Selected Alerts Into Incident: ${_objKey} - ${strClientName}</h5></div>                   
                  ...
                  <i class="fa fa-calendar" style="font-size: medium"></i> Filter Date
                  </button>
                    <button type="text" id="ViewAll" class="btn btn-secondary input-sm custom-input" >
