...
(function (root, factory) {
  ...
  QueryBuilder.templates.group =
    '\
<div id="{{= it.group_id }}" class="rules-group-container col-md-12"> \
        ...
        default:
          if (
            ...
            h +=
              ...
              '" type="text" name="' +
              name +
              `" class="txtCalendar" placeholder= ${dashResources.get(
                "date"
              )}/>`;
            ArrCalendar.push({
              txtId: name,
...
<div" +
  ...
  QueryBuilder.regional["en"] = {
    ...
    add_rule: dashResources.get("addcondi"),
    add_group: dashResources.get("addgroup"),
    delete_rule: " ",
    delete_group: " ",

    conditions: {
      AND: dashResources.get("and"),
      OR: dashResources.get("or"),
    },

    operators: {
      equal: dashResources.get("equal"),
      not_equal: dashResources.get("not_equal"),
      in: dashResources.get("in"),
      not_in: dashResources.get("not_in"),
      less: dashResources.get("less"),
      less_or_equal: dashResources.get("less_or_equal"),
      greater: dashResources.get("greater"),
      greater_or_equal: dashResources.get("greater_or_equal"),
      between: dashResources.get("between"),
      not_between: dashResources.get("not_between"),
      begins_with: dashResources.get("begins_with"),
      not_begins_with: dashResources.get("not_begins_with"),
      contains: dashResources.get("contains"),
      not_contains: dashResources.get("not_contains"),
      ends_with: dashResources.get("ends_with"),
      not_ends_with: dashResources.get("not_ends_with"),
      is_empty: dashResources.get("is_empty"),
      is_not_empty: dashResources.get("is_not_empty"),
      is_null: dashResources.get("is_null"),
      is_not_null: dashResources.get("is_not_null"),
    },
    errors: {
      no_filter: dashResources.get("no_filter"),
      empty_group: dashResources.get("empty_group"),
      radio_empty: dashResources.get("radio_empty"),
      checkbox_empty: dashResources.get("checkbox_empty"),
      select_empty: dashResources.get("select_empty"),
      string_empty: dashResources.get("string_empty"),
      string_exceed_min_length: dashResources.get("string_exceed_min_length"),
      string_exceed_max_length: dashResources.get("string_exceed_max_length"),
      string_invalid_format: dashResources.get("string_invalid_format"),
      number_nan: dashResources.get("number_nan"),
      number_not_integer: dashResources.get("number_not_integer"),
      number_not_double: dashResources.get("number_not_double"),
      number_exceed_min: dashResources.get("number_exceed_min"),
      number_exceed_max: dashResources.get("number_exceed_max"),
      number_wrong_step: dashResources.get("number_wrong_step"),
      number_between_invalid: dashResources.get("number_between_invalid"),
      datetime_empty: dashResources.get("datetime_empty"),
      datetime_invalid: dashResources.get("datetime_invalid"),
      datetime_exceed_min: dashResources.get("datetime_exceed_min"),
      datetime_exceed_max: dashResources.get("datetime_exceed_max"),
      datetime_between_invalid: dashResources.get("datetime_between_invalid"),
      boolean_not_valid: dashResources.get("boolean_not_valid"),
      operator_not_multiple: dashResources.get("operator_not_multiple"),
    },
    invert: dashResources.get("invert"),
    NOT: dashResources.get("not"),
  };
