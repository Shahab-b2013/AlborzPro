...
(function (factory) {
    ...
    tCaption = '<div tabindex="500" class="form-control file-caption form-input {class}">\n' + 
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'btn btn-default btn-browse-file',//Custom
    ...
    // if ($$Lang == 'Fa') {
        ...
        $.fn.fileinputLocales.en = {
            ...
            msgSizeTooLarge: 'فایل "{name}" (<b>{size} کیلوبایت</b>) از حداکثر مجاز <b>{maxSize} کیلوبایت</b> بیشتر است.',
