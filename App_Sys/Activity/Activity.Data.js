...
function aData(id, objKey, parentObjKey, requestDate) {
    ...
    $.ajax({
        ...
        url: objKey != null && objKey != 0 ? '../App_Sys/Services/ViewActivity.asmx/GetDataObject' : '../App_Sys/Services/ViewActivity.asmx/GetDataObjects',

        data: objKey != null && objKey != 0 ? '{"id":"' + _activityID + '","objKey":"' + _objKey + '","responseToken":"' + genResponseToken() + '"}' : '{"id":"' + _activityID + '","parentObjKey":"' + _parentObjKey + '","responseToken":"' + genResponseToken() + '","requestDate":"' + _requestDate + '"}',
...
function ahData(id, objKey) {
    ...
    $.ajax({
        ...
        data: '{"id":"' + _activityID + '","objKey":"' + _objKey + '","responseToken":"' + genResponseToken() + '"}',
...
function aDataVisualization(id, seriesOptions, categoryExp, seriesExps, advancedSearch, objKey) {
    ...
    $.ajax({
        ...
        data: '{"id":"' + _activityID + '","seriesOptions":' + JSON.stringify(_seriesOptions) + ',"categoryExp":"' + _categoryExp + '","seriesExps":' + JSON.stringify(_seriesExps) + ',"advancedSearch":' + JSON.stringify(_advancedSearch) + ',"objKey":"' + _objKey + '","responseToken":"' + genResponseToken() + '"}',
...
function rDataRegion(id, dataRegionID, pageNumber, advancedSearch, objKey, order) {
    ...
    $.ajax({
        ...
        data: '{"id":"' + _reportID + '","dataRegionID":"' + _dataRegionID + '","pageNumber":"' + _pageNumber + '","advancedSearch":' + JSON.stringify(_advancedSearch) + ',"objKey":"' + _objKey + '","order":' + JSON.stringify(_order) + ',"responseToken":"' + genResponseToken() + '"}',
...
function rDataList(id, dataRegionID, start, length, advancedSearch, objKey, order) {
    ...
    $.ajax({
        ...
        data: '{"id":"' + _reportID + '","dataRegionID":"' + _dataRegionID + '","length":"' + _length + '","start":"' + _start + '","advancedSearch":' + JSON.stringify(_advancedSearch) + ',"objKey":"' + _objKey + '","order":' + JSON.stringify(_order) + ',"responseToken":"' + genResponseToken() + '"}',
...
function rDataVisualization(id, dataVisualizationID, seriesOptions, categoryExp, seriesExps, advancedSearch, objKey) {
    ...
    $.ajax({
        ...
        data: '{"id":"' + _reportID + '","dataVisualizationID":"' + _dataVisualizationID + '","seriesOptions":' + JSON.stringify(_seriesOptions) + ',"categoryExp":"' + _categoryExp + '","seriesExps":' + JSON.stringify(_seriesExps) + ',"advancedSearch":' + JSON.stringify(_advancedSearch) + ',"objKey":"' + _objKey + '","responseToken":"' + genResponseToken() + '"}',
