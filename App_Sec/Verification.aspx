    ...
    <form id="frmloginup">
        <div class="login-box">
            ...
            <div class="login-box-body">
                <p class="login-box-msg"><%=LocalizationProvider.Login_SendVerifyCodeMessage %></p>
                <p id="login-msg" class="login-box-msg" dir="ltr"><%--<=SessionProvider.GetSemiValue("IEmailID") >--%></p>
