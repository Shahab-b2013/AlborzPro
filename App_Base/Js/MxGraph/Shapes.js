...
(function () {
  ...
  //UmlParallelGateway Shape
  function Parallel() {
    mxShape.call(this);
  }
  mxUtils.extend(Parallel, mxShape);
  Parallel.prototype.paintVertexShape = function (c, x, y, w, h) {
    c.translate(x, y);
  ...
  mxCellRenderer.registerShape("Parallel", Parallel);
  ...
  StateShape.prototype.paintVertexShape = function (c, x, y, w, h) {
    var inset = Math.min(3, Math.min(w / 5, h / 5));
  ...
  mxUtils.extend(Exclusive, mxRhombus);
  Exclusive.prototype.paintVertexShape = function (c, x, y, w, h) {
    mxRhombus.prototype.paintVertexShape.apply(this, arguments);
    var s2 = 0;
    w = 15;
    h = 15;
	...
	mxCellRenderer.registerShape("Exclusive", Exclusive);
	
  // Inclusive
  function Inclusive() {
    mxRhombus.call(this);
  }
  mxUtils.extend(Inclusive, mxRhombus);
  Inclusive.prototype.paintVertexShape = function (c, x, y, w, h) {
    mxRhombus.prototype.paintVertexShape.apply(this, arguments);
    w = 28;
    h = 28;
    x = x + 6;
  ...
  mxCellRenderer.registerShape("Inclusive", Inclusive);
  ...
  mxUtils.extend(Parallel, mxRhombus);
  Parallel.prototype.paintVertexShape = function (c, x, y, w, h) {
    mxRhombus.prototype.paintVertexShape.apply(this, arguments);
    w = 20;
    h = 20;
