...
Sidebar.prototype.init = function () {
    ...
    this.addTasksPalette(dir, false);

    this.addGatewaysPalette(dir, false);
    this.addEventsPalette(dir, false);
    this.addSwin_LanePalette(dir, false);
    this.addConnectorsPalette(dir, false);
    this.addSettingsPalette(dir, false);
};
 ...
 */
// var right_gif_BS64 =
// "";

// var down_gif_BS64 =
// "";

// Sidebar.prototype.collapsedImage = !mxClient.IS_SVG
//   ? IMAGE_PATH + "/collapsed.gif"
//   : `data:image/gif;base64,${right_gif_BS64}`;
...
//   : `data:image/gif;base64,${down_gif_BS64}`;
 ...
 */
Sidebar.prototype.thumbHeight = 102;
            ...
            var show = mxUtils.bind(this, function () {
                ...
                if (this.tooltipTitles && title != null && title.length > 0) {
                    if (this.tooltipTitle == null) {
                        ...
                        this.tooltipTitle.style.overflow = "hiden";
                        this.tooltipTitle.style.position = "absolute";
                        this.tooltipTitle.style.paddingTop = "6px";
                        this.tooltipTitle.style.bottom = "4px";
                        this.tooltipTitle.style.font = "14px IRANSansWeb";
...
Sidebar.prototype.addGeneralPalette = function (expand) {
    ...
    var sb = this;
    this.setCurrentSearchEntryLibrary("Swin Lane");
    var lane = new mxCell(
        "Lane",
        new mxGeometry(0, 0, 320, 120),
        "swimlane;horizontal=0;fillColor=#FFF6D9;type=Lane"
    );
    lane.vertex = true;
    var fns = [
        this.addEntry(
            this.getTagsForStencil("mxgraph.bpmn", "user task").join(" "),
            function () {
                var cell = new mxCell(
                    "",
                    new mxGeometry(0, 0, 150, 70),
                    "html=1;whiteSpace=wrap;rounded=1;resizable=0;outlineConnect=0;dropTarget=0;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;gradientColor=#ebf4ff;type=UserTask"
                );
                cell.vertex = true;
                var cell1 = new mxCell(
                    "",
                    new mxGeometry(0, 0, 20, 20),
                    "html=1;shape=mxgraph.bpmn.user_task;outlineConnect=0;locked=1;resizable=0;strokeWidth=2;dropTarget=0fillColor=#f9fdfe;strokeColor=#156c7d;"
                );
                cell1.vertex = true;
                ...
                return sb.createVertexTemplateFromCells(
                    ...
                    mxResources.get("UserTask")
                );
            }
        ),

        this.createVertexTemplateEntry(
            "shape=Exclusive;resizable=0;verticalLabelPosition=bottom;strokeWidth=2;strokeColor=#e3d7b5;fillColor=#fafff2;type=Exclusive Gateway",
            40,
            40,
            "",
        ...
        this.createVertexTemplateEntry(
            "ellipse;whiteSpace=wrap;html=1;resizable=0;verticalLabelPosition=center;aspect=fixed;strokeWidth=2;strokeColor=#006633;fillColor=#d5e8d4;type=StartEvent",
            40,
            40,
            "",
        ...
        this.createVertexTemplateEntry(
            "ellipse;whiteSpace=wrap;html=1;resizable=0;verticalLabelPosition=center;aspect=fixed;strokeWidth=4;strokeColor=#990000;fillColor=#ffcccc;type=EndEvent",
            40,
            40,
            "",
        ...
        this.createVertexTemplateEntry(
            "text;html=1;strokeColor=none;fillColor=none;verticalAlign=middle;whiteSpace=wrap;rounded=0;align=left;",
            40,
            28,
            "[Text]",
            "Text",
        ...
        this.createVertexTemplateEntry(
            "text;html=1;strokeColor=none;fillColor=none;spacing=5;spacingTop=-20;whiteSpace=wrap;overflow=hidden;rounded=0;align=left;",
            190,
            80,
        ...
        this.addEntry("", function () {
            var cell = new mxCell(
                "Pool",
                new mxGeometry(0, 0, 680, 360),
                "swimlane;fontStyle=1;fillColor=#FFF6D9;align=center;verticalAlign=top;childLayout=stackLayout;horizontal=0;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;marginBottom=0;type=Pool"
            );
            cell.vertex = true;
            cell.insert(sb.cloneCell(lane, "Lane 1"));
            cell.insert(sb.cloneCell(lane, "Lane 2"));
            cell.insert(sb.cloneCell(lane, "Lane 3"));
        ...
        //this.addEntry(
        //    this.getTagsForStencil("mxgraph.bpmn", "Intermediate Timer Event").join(
        //        " "
        //    ),
        //    function () {
        //        var cell = new mxCell(
        ...
        //            "ellipse;html=1;verticalLabelPosition=bottom;locked=0;shape=endState;dropTarget=0;fillColor=#E3D7B5;strokeColor=#ab9144;resizable=0;type=IntermediateTimerEvent"
        //        );
        //        cell.vertex = true;
        //        var cell1 = new mxCell(
        //            "",
        //            new mxGeometry(1.1, 0.48, 32.5, 32.5),
        //            "shape=mxgraph.bpmn.timer_intermediate;perimeter=ellipsePerimeter;html=1;locked=0;resizable=0;dropTarget=0;verticalLabelPosition=bottom;verticalAlign=top;outlineConnect=0;strokeWidth=2;strokeColor=#ab9144;fillColor=#E3D7B5;"
        //        );
        //        cell1.vertex = true;
        //        cell1.geometry.relative = true;
        //        cell1.setConnectable(false);
        ...
        //            cell.geometry.width,
        //            cell.geometry.height,
        //            mxResources.get("IntermediateTimerEvent")
        //        );
        //    }
        //),
    ];
...
/**
 * Adds the TASK library to the sidebar.
 */
Sidebar.prototype.addTasksPalette = function (dir, expand) {
    var sb = this;
    ...
    var fns = [
        this.addEntry(
            ...
            function () {
                ...
                var cell1 = new mxCell(
                    "",
                    new mxGeometry(0, 0, 20, 20),
                    "html=1;shape=mxgraph.bpmn.user_task;outlineConnect=0;locked=1;resizable=0;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;"
                );
                cell1.vertex = true;
                cell1.geometry.relative = true;
                cell1.setConnectable(false);
        ...
        // this.addEntry(
        //   this.getTagsForStencil("mxgraph.bpmn", "UserTaskTimer").join(" "),
        //   function () {
        //     var cell = new mxCell(
        //       "",
        //       new mxGeometry(0, 0, 150, 70),
        //       "html=1;whiteSpace=wrap;rounded=1;outlineConnect=0;resizable=0;strokeWidth=2;dropTarget=0;fillColor=#f9fdfe;strokeColor=#156c7d;gradientColor=#ebf4ff;type=UserTaskTimer"
        //     );
        //     cell.vertex = true;
        //     var cell1 = new mxCell(
        //       "",
        //       new mxGeometry(0, 0, 20, 20),
        //       "html=1;shape=mxgraph.bpmn.user_task;outlineConnect=0;locked=1;resizable=0;strokeWidth=2;dropTarget=0;fillColor=#f9fdfe;strokeColor=#156c7d;gradientColor=#ebf4ff;"
        //     );
        //     cell1.vertex = true;
        //     cell1.geometry.relative = true;
        //     cell1.setConnectable(false);
        ...
        //       "",
        //       new mxGeometry(0, 0, 25, 25),
        //       "ellipse;html=1;resizable=0;verticalLabelPosition=bottom;locked=1;shape=endState;dropTarget=0;fillColor=#f9fdfe;strokeColor=#156c7d;"
        //     );
        //     cell2.vertex = true;
        //     cell2.geometry.relative = true;
        //     cell2.geometry.offset = new mxPoint(110, 54);
        //     cell2.setConnectable(false);
        //     var timer = new mxCell(
        //       "",
        //       new mxGeometry(1.1, 0.48, 22.5, 22.5),
        //       "shape=mxgraph.bpmn.timer_intermediate;perimeter=ellipsePerimeter;html=1;locked=1;resizable=0;dropTarget=0;verticalLabelPosition=bottom;verticalAlign=top;outlineConnect=0;strokeWidth=2;strokeColor=#156c7d;fillColor=#f9fdfe;"
        //     );
        //     timer.vertex = true;
        //     timer.geometry.relative = true;
        //     timer.setConnectable(false);
        //     timer.geometry.offset = new mxPoint(-26, -10.5);
        //     cell2.insert(timer);
        //     cell.insert(cell2);
        //     return sb.createVertexTemplateFromCells(
        //       [cell],
        //       cell.geometry.width,
        //       cell.geometry.height,
        //       mxResources.get("UserTaskTimer")
        //     );
        //   }
        // ),
        this.addEntry(
            this.getTagsForStencil("mxgraph.bpmn", "service task").join(" "),
            function () {
                var cell = new mxCell(
                    "",
                    new mxGeometry(0, 0, 150, 70),
                    "shape=ext;rounded=1;html=1;whiteSpace=wrap;outlineConnect=0;resizable=0;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;gradientColor=#ebf4ff;type=ServiceTask"
                );
                cell.vertex = true;
                var cell1 = new mxCell(
                    "",
                    new mxGeometry(0, 0, 22, 22),
                    "shape=mxgraph.bpmn.service_task;html=1;locked=1;resizable=0;outlineConnect=0;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;"
                );
                cell1.vertex = true;
                cell1.geometry.relative = true;
                cell1.setConnectable(false);
                ...
                return sb.createVertexTemplateFromCells(
                    ...
                    cell.geometry.width,
                    cell.geometry.height,
                    mxResources.get("ServiceTask")
                );
            }
        ),
        //    this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'receive task').join(' '), function () {
        // 	   var cell = new mxCell('', new mxGeometry(0, 0, 150, 70), 'shape=ext;rounded=1;html=1;outlineConnect=0;resizable=0;whiteSpace=wrap;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;gradientColor=#ebf4ff;type=ReceiveTask');
        // 	   cell.vertex = true;
        // 	   var cell1 = new mxCell('', new mxGeometry(0, 0, 45, 35), 'shape=message;locked=1;outlineConnect=0;resizable=0;whiteSpace=wrap;html=1;outlineConnect=0;strokeWidth=2;strokeWidth=2;fillColor=#156c7d;strokeColor=#f9fdfe;');
        // 	   cell1.vertex = true;
        // cell1.setConnectable(false);
        // 	   cell1.geometry.relative = true;
        // 	   cell1.geometry.offset = new mxPoint(7, 7);
        // 	   cell.insert(cell1);
        // 	   return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, mxResources.get("ReceiveTask"));
        //    }),
        //    this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'send task').join(' '), function () {
        // 	   var cell = new mxCell('', new mxGeometry(0, 0, 150, 70), 'shape=ext;rounded=1;html=1;outlineConnect=0;resizable=0;whiteSpace=wrap;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;gradientColor=#ebf4ff;type=SendTask');
        // 	   cell.vertex = true;
        // 	   var cell1 = new mxCell('', new mxGeometry(0, 0, 50, 40), 'shape=message;whiteSpace=wrap;html=1;locked=1;outlineConnect=0;resizable=0;outlineConnect=0;fillColor=#000000;strokeColor=#ffffff;strokeWidth=2;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;');
        // 	   cell1.vertex = true;
        // cell1.setConnectable(false);
        // 	   cell1.geometry.relative = true;
        // 	   cell1.geometry.offset = new mxPoint(7, 7);
        // 	   cell.insert(cell1);
        // 	   return sb.createVertexTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, mxResources.get("SendTask"));
        //    }),
        // this.addEntry(
        //   this.getTagsForStencil("mxgraph.bpmn", "script task").join(" "),
        //   function () {
        //     var cell = new mxCell(
        //       "",
        //       new mxGeometry(0, 0, 150, 70),
        //       "shape=ext;rounded=1;html=1;whiteSpace=wrap;outlineConnect=0;resizable=0;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;gradientColor=#ebf4ff;type=ScriptTask"
        //     );
        //     cell.vertex = true;
        //     var cell1 = new mxCell(
        //       "",
        //       new mxGeometry(0, 0, 30, 35),
        //       "shape=mxgraph.bpmn.script_task;html=1;locked=1;outlineConnect=0;resizable=0;outlineConnect=0;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;"
        //     );
        //     cell1.vertex = true;
        //     cell1.geometry.relative = true;
        //     cell1.setConnectable(false);
        ...
        //       cell.geometry.width,
        //       cell.geometry.height,
        //       mxResources.get("ScriptTask")
        //     );
        //   }
        // ),

        this.addEntry(
            this.getTagsForStencil("mxgraph.bpmn", "manual task").join(" "),
            function () {
                var cell = new mxCell(
                    "",
                    new mxGeometry(0, 0, 150, 70),
                    "shape=ext;rounded=1;html=1;whiteSpace=wrap;outlineConnect=0;resizable=0;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;gradientColor=#ebf4ff;type=ManualTask"
                );
                cell.vertex = true;
                var cell1 = new mxCell(
                    "",
                    new mxGeometry(0, 0, 20, 15),
                    "shape=mxgraph.bpmn.manual_task;html=1;locked=1;outlineConnect=0;resizable=0;outlineConnect=0;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;"
                );
                cell1.vertex = true;
                cell1.geometry.relative = true;
                cell1.setConnectable(false);
                cell1.geometry.offset = new mxPoint(5, 7);
                cell.insert(cell1);
                return sb.createVertexTemplateFromCells(
                    [cell],
                    cell.geometry.width,
                    cell.geometry.height,
                    mxResources.get("ManualTask")
                );
            }
        ),
        // this.addEntry(
        //   this.getTagsForStencil("mxgraph.bpmn", "business rule task").join(" "),
        //   function () {
        //     var cell = new mxCell(
        //       "",
        //       new mxGeometry(0, 0, 150, 70),
        //       "shape=ext;rounded=1;html=1;whiteSpace=wrap;strokeWidth=2;outlineConnect=0;resizable=1;fillColor=#f9fdfe;strokeColor=#156c7d;gradientColor=#ebf4ff;type=BusinessRuleTask"
        //     );
        //     cell.vertex = true;
        //     var cell1 = new mxCell(
        //       "",
        //       new mxGeometry(0, 0, 35, 25),
        //       "shape=mxgraph.bpmn.business_rule_task;html=1;locked=1;outlineConnect=0;resizable=0;outlineConnect=0;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;"
        //     );
        //     cell1.vertex = true;
        //     cell1.geometry.relative = true;
        //     cell1.setConnectable(false);
    ...
    this.addPaletteFunctions("task", mxResources.get("Task"), false, fns);
    this.setCurrentSearchEntryLibrary();
};

/**
 * Adds the Sub_Process library to the sidebar.
 */
Sidebar.prototype.addSub_ProcessPalette = function (dir, expand) {
    var sb = this;
    this.setCurrentSearchEntryLibrary("Sub Process");

    var fns = [
        this.addEntry("Sub Process", function () {
            var cell = new mxCell(
                "",
                new mxGeometry(0, 0, 150, 70),
                "html=1;whiteSpace=wrap;rounded=1;dropTarget=0;resizable=0;strokeWidth=2;type=SubProcess"
            );
            cell.vertex = true;

            var cell1 = new mxCell(
                "",
                new mxGeometry(0.48, 0.9, 20, 20),
                "html=1;locked=1;shape=plus;outlineConnect=0;resizable=0;strokeWidth=2;"
            );
            cell1.vertex = true;
            cell1.geometry.relative = true;
            cell1.setConnectable(false);
        ...
        this.createVertexTemplateEntry(
            "shape=ext;rounded=1;html=1;whiteSpace=wrap;resizable=0;strokeWidth=4;type=Call Activity Sub Process",
            150,
            70,
            "",
            mxResources.get("CallActivity"),
            null,
            null
        ),
        this.createVertexTemplateEntry(
            "shape=ext;rounded=1;html=1;whiteSpace=wrap;double=1;resizable=0;strokeWidth=2;type=Transaction Sub Process",
            150,
            70,
            "",
            mxResources.get("TransactionSubProcess"),
            null,
            null
        ),
    ];
...
/**
 * Adds the Marker library to the sidebar.
 */
Sidebar.prototype.addMarkerPalette = function (dir, expand) {
    var sb = this;
    this.setCurrentSearchEntryLibrary("Marker");

    var fns = [
        this.createVertexTemplateEntry(
            "shape=mxgraph.bpmn.loop;html=1;outlineConnect=0;strokeWidth=2;type=Loop",
            40,
            40,
            "",
            mxResources.get("Loop"),
            null,
            null,
            "bpmn loop marker"
        ),
        this.createVertexTemplateEntry(
            "shape=parallelMarker;html=1;outlineConnect=0;type=parallel",
            40,
            40,
            "",
            mxResources.get("ParallelMI"),
            null,
            null,
            "bpmn parallel mi marker"
        ),
        this.createVertexTemplateEntry(
            "shape=parallelMarker;direction=south;html=1;outlineConnect=0;type=Sequential",
            40,
            40,
            "",
            mxResources.get("Sequential"),
            null,
            null,
            "bpmn sequential mi marker"
        ),
        this.createVertexTemplateEntry(
            "shape=mxgraph.bpmn.ad_hoc;fillColor=#000000;html=1;outlineConnect=0;type=Ad Hoc",
            40,
            20,
            "",
            mxResources.get("SequeAdHocntial"),
            null,
            null,
            "bpmn ad hoc marker"
        ),
        this.createVertexTemplateEntry(
            "shape=mxgraph.bpmn.compensation;html=1;outlineConnect=0;strokeWidth=2;type=Compensation",
            40,
            20,
            "",
            mxResources.get("Compensation"),
            null,
            null,
            "bpmn compensation marker"
        ),
    ];
    this.addPaletteFunctions("Marker", "Marker", false, fns);
    this.setCurrentSearchEntryLibrary();
};
/**
 * Adds the Gateways library to the sidebar.
 */
Sidebar.prototype.addGatewaysPalette = function (dir, expand) {
    var sb = this;
    this.setCurrentSearchEntryLibrary("Gateways");
    ...
    var fns = [
        ...
        this.createVertexTemplateEntry(
            "shape=Inclusive;resizable=0;verticalLabelPosition=bottom;strokeWidth=2;strokeColor=#e3d7b5;fillColor=#fafff2;type=Inclusive Gateway",
            40,
            40,
            "",
        ...
        this.createVertexTemplateEntry(
            "shape=Parallel;resizable=0;verticalLabelPosition=bottom;strokeWidth=2;strokeColor=#e3d7b5;fillColor=#fafff2;type=Parallel Gateway",
            40,
            40,
            "",
    ...
    this.addPaletteFunctions("Gateways", "Gateways", false, fns);
    this.setCurrentSearchEntryLibrary();
};
/**
 * Adds the Events library to the sidebar.
 */
Sidebar.prototype.addEventsPalette = function (dir, expand) {
    var sb = this;
    this.setCurrentSearchEntryLibrary("Events");

    var fns = [
        //start
        this.createVertexTemplateEntry(
            "ellipse;resizable=0;whiteSpace=wrap;html=1;verticalLabelPosition=center;aspect=fixed;strokeWidth=2;strokeColor=#006633;fillColor=#d5e8d4;type=StartEvent",
            40,
            40,
            "",
            mxResources.get("StartEvent"),
        ...
        // this.addEntry(
        //   this.getTagsForStencil("mxgraph.bpmn", "Message Start Event").join(" "),
        //   function () {
        //     var cell = new mxCell(
        //       "",
        //       new mxGeometry(0, 0, 40, 40),
        //       "ellipse;resizable=0;whiteSpace=wrap;html=1;verticalLabelPosition=bottom;aspect=fixed;strokeWidth=2;strokeColor=#006633;fillColor=#d5e8d4;type=MessageStartEvent"
        //     );
        //     cell.vertex = true;
        //     var cell1 = new mxCell(
        //       "",
        //       new mxGeometry(0, 0.13, 25, 16),
        //       "shape=message;resizable=0;whiteSpace=wrap;html=1;locked=1;outlineConnect=1;strokeWidth=2;strokeColor=#006633;fillColor=#d5e8d4;"
        //     );
        //     cell1.vertex = true;
        //     cell1.geometry.relative = true;
        //     cell1.setConnectable(false);
        ...
        //       cell.geometry.width,
        //       cell.geometry.height,
        //       mxResources.get("MessageStartEvent")
        //     );
        //   }
        // ),

        //this.addEntry(
        //    this.getTagsForStencil("mxgraph.bpmn", "timer start Event").join(" "),
        //    function () {
        //        var cell = new mxCell(
        //            "",
        //            new mxGeometry(0, 0, 40, 40),
        //            "shape=mxgraph.bpmn.timer_start;resizable=0;whiteSpace=wrap;html=1;verticalLabelPosition=bottom;aspect=fixed;strokeWidth=2;strokeColor=#006633;fillColor=#d5e8d4;type=TimerStartEvent"
        //        );
        //        cell.vertex = true;
        ...
        //            cell.geometry.width,
        //            cell.geometry.height,
        //            mxResources.get("TimerStartEvent")
        //        );
        //    }
        //),
        //  this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'Conditional Start Event').join(' '), function()
        //  {
        //  var cell = new mxCell('', new mxGeometry(0, 0, 40, 40), 'ellipse;whiteSpace=wrap;html=1;verticalLabelPosition=bottom;resizable=0;aspect=fixed;strokeWidth=2;strokeColor=#006633;fillColor=#d5e8d4;type=ConditionalStartEvent');
        //  cell.vertex = true;

        //  var cell1 = new mxCell('', new mxGeometry(1.24, 0.62, 21, 21), 'shape=mxgraph.bpmn.script_task;html=1;locked=1;resizable=0;outlineConnect=0;strokeWidth=4;strokeColor=#006633;fillColor=#d5e8d4;');
        //  cell1.vertex = true;
        //  cell1.geometry.relative = true;
        //cell1.setConnectable(false);
        //  cell1.geometry.offset = new mxPoint(-40, -15);
        ...
        //  return sb.createVertexTemplateFromCells([cell], 120, 95, mxResources.get("ConditionalStartEvent"));
        //  }),

        // //Double Events
        // this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'Intermediate Message Event').join(' '), function()
        // {
        // var cell = new mxCell('', new mxGeometry(0, 0, 40, 40), 'ellipse;html=1;shape=endState;verticalLabelPosition=bottom;resizable=0;fillColor=#E3D7B5;strokeColor=#ab9144;type=IntermediateMessageEvent');
        // cell.vertex = true;
        // var cell1 = new mxCell('', new mxGeometry(1.25, 0.71, 21, 12), 'shape=message;whiteSpace=wrap;locked=1;resizable=0;html=1;outlineConnect=1;strokeWidth=2;strokeColor=#ab9144;fillColor=#E3D7B5;');
        // cell1.vertex = true;
        // cell1.geometry.relative = true;
        //  cell1.setConnectable(false);
        // cell1.geometry.offset = new mxPoint(-40, -15);
        // cell.insert(cell1);
        // return sb.createVertexTemplateFromCells([cell], 120, 95, mxResources.get("IntermediateMessageEvent"));
        // }),
        //this.addEntry(
        //    this.getTagsForStencil("mxgraph.bpmn", "Intermediate Timer Event").join(
        //        " "
        ...
        //    }
        //),
        // this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'Intermediate Conditional Event').join(' '), function()
        // {
        // var cell = new mxCell('', new mxGeometry(0, 0, 40, 40), 'ellipse;html=1;verticalLabelPosition=bottom;shape=endState;resizable=0;fillColor=#E3D7B5;strokeColor=#ab9144;type=IntermediateConditionalEvent');
        // cell.vertex = true;
        // var cell1 = new mxCell('', new mxGeometry(1.26, 0.63, 18, 18), 'shape=mxgraph.bpmn.script_task;html=1;locked=1;resizable=0;outlineConnect=0;strokeWidth=2;strokeColor=#ab9144;fillColor=#E3D7B5;');
        // cell1.vertex = true;
        // cell1.geometry.relative = true;
        //  cell1.setConnectable(false);
        // cell1.geometry.offset = new mxPoint(-40, -15);
        // cell.insert(cell1);
        // return sb.createVertexTemplateFromCells([cell], 120, 95,mxResources.get("IntermediateConditionalEvent"));
        // }),
        // this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'Compensation Event 1').join(' '), function()
        // {
        // var cell = new mxCell('', new mxGeometry(0, 0, 40, 40), 'ellipse;html=1;shape=endState;verticalLabelPosition=bottom;resizable=0;fillColor=#E3D7B5;strokeColor=#ab9144;type=CompensationEvent');
        // cell.vertex = true;
        // var cell1 = new mxCell('', new mxGeometry(1.24, 0.66, 18, 14), 'shape=mxgraph.bpmn.compensation;html=1;locked=1;resizable=0;outlineConnect=0;strokeWidth=2;strokeColor=#ab9144;fillColor=#E3D7B5;');
        // cell1.vertex = true;
        // cell1.geometry.relative = true;
        //  cell1.setConnectable(false);
        //  cell1.geometry.offset = new mxPoint(-40, -15);
        // cell.insert(cell1);
        // return sb.createVertexTemplateFromCells([cell], 120, 95,mxResources.get("CompensationEvent"));
        // }),
        // this.addEntry(this.getTagsForStencil('mxgraph.bpmn', 'Terminate End Event').join(' '), function()
        //  {
        //  var cell = new mxCell('', new mxGeometry(0, 0, 40, 40), 'ellipse;html=1;shape=endState;verticalLabelPosition=bottom;strokeWidth=4;fillColor=#E3D7B5;strokeColor=#ab9144;type=TerminateEndEvent');
        //  cell.vertex = true;
        //  return sb.createVertexTemplateFromCells([cell], 120, 95,mxResources.get("TerminateEndEvent"));
        //  }),

        //End Events
        this.createVertexTemplateEntry(
            "ellipse;whiteSpace=wrap;html=1;aspect=fixed;strokeWidth=4;verticalLabelPosition=center;strokeColor=#990000;resizable=0;fillColor=#ffcccc;type=EndEvent",
            40,
            40,
            "",
            mxResources.get("EndEvent"),
        ...
        // this.addEntry(
        //   this.getTagsForStencil("mxgraph.bpmn", "Message End Event").join(" "),
        //   function () {
        //     var cell = new mxCell(
        //       "",
        //       new mxGeometry(0, 0, 40, 40),
        //       "ellipse;whiteSpace=wrap;html=1;aspect=fixed;strokeWidth=4;verticalLabelPosition=center;resizable=0;strokeColor=#990000;fillColor=#ffcccc;type=MessageEndEvent"
        //     );
        //     cell.vertex = true;
        //     var cell1 = new mxCell(
        //       "",
        //       new mxGeometry(0, 0.13, 25, 16),
        //       "shape=message;whiteSpace=wrap;html=1;outlineConnect=0;strokeWidth=2;locked=1;resizable=0;strokeColor=#ffcccc;fillColor=#990000;"
        //     );
        //     cell1.vertex = true;
        //     cell1.geometry.relative = true;
        //     cell1.setConnectable(false);
        ...
        //       cell.geometry.width,
        //       cell.geometry.height,
        //       mxResources.get("MessageEndEvent")
        //     );
        //   }
        // ),
    ];
    this.addPaletteFunctions("Events", "Events", false, fns);
    this.setCurrentSearchEntryLibrary();
};
/**
 * Adds the Artifacts library to the sidebar.
 */

/**
 * Adds the Swin_Lane library to the sidebar.
 */
Sidebar.prototype.addSwin_LanePalette = function (dir, expand) {
    var sb = this;
    this.setCurrentSearchEntryLibrary("Swin Lane");
    var lane = new mxCell(
        "Lane",
    ...
    var fns = [
        ...
        this.createVertexTemplateEntry(
            "swimlane;startSize=20;fillColor=#FFF6D9;type=Lane",
            120,
            320,
            "Lane",
            "Vertical Swimlane",
    ...
    this.addPaletteFunctions("Swin Lane", "SwinLane", false, fns);
    this.setCurrentSearchEntryLibrary();
};

/**
 * Adds the Connectors library to the sidebar.
 */
Sidebar.prototype.addConnectorsPalette = function (dir, expand) {
    var sb = this;
    var lineTags =
        "line lines connector connectors connection connections arrow arrows ";

    this.setCurrentSearchEntryLibrary("Connectors");
    ...
    var fns = [
        this.addEntry("bpmn sequence flow", function () {
            var edge = new mxCell(
                ...
                "endArrow=block;endFill=1;html=1;edgeStyle=orthogonalEdgeStyle;align=left;verticalAlign=top;type=Connection"
            );
            ...
            var cell = new mxCell(
                ...
                "edgeLabel;html=1;align=left;verticalAlign=bottom;"
            );
            ...
            return sb.createEdgeTemplateFromCells([edge], 160, 0, "SequenceFlow");
        }),
        // this.addEntry("bpmn default flow", function () {
        //   var edge = new mxCell(
        //     "",
        //     new mxGeometry(0, 0, 0, 0),
        //     "startArrow=dash;endArrow=block;endFill=1;html=1;edgeStyle=orthogonalEdgeStyle;align=left;verticalAlign=top;type=Connection"
        //   );
        //   edge.geometry.setTerminalPoint(new mxPoint(0, 0), true);
        //   edge.geometry.setTerminalPoint(new mxPoint(160, 0), false);
        //   edge.geometry.relative = true;
        ...
        //   return sb.createEdgeTemplateFromCells([edge], 160, 0, "DefaultFlow");
        // }),

        // this.createEdgeTemplateEntry('endArrow=block;dashed=1;endFill=0;endSize=12;html=1;type=Connection', 100, 0, '', 'Association', null, 'Association','Association'),
        // this.createEdgeTemplateEntry('startArrow=oval;startFill=0;startSize=7;endArrow=block;endFill=0;endSize=10;dashed=1;html=1;type=Connection', 100, 0, '', 'MessageFlow', null, 'bpmn message flow','MessageFlow'),
    ...
    this.addPaletteFunctions("Connectors", "Connectors", false, fns);
    this.setCurrentSearchEntryLibrary();
};

/**
 * Adds the Settings library to the sidebar.
   Data Process & Doc Designer
 */
Sidebar.prototype.addSettingsPalette = function (dir, expand) {
    let div = document.createElement("div");
    //link 1
    let divchild1 = document.createElement("div");
    divchild1.style.cursor = "pointer";

    let img = document.createElement("img");
    img.className = "";
    img.setAttribute("draggable", false);
    img.setAttribute("src", `data:image/png;base64,` + $DataProcess);
    img.style.width = "18px";
    img.style.height = "18px";
    divchild1.appendChild(img);

    let likn1 = document.createElement("span");
    likn1.textContent = mxResources.get("Processdata");
    likn1.className = "span";
    likn1.setAttribute("changeLang", "Processdata");
    divchild1.appendChild(likn1);

    //_JsonVariable get by Process.js
    divchild1.addEventListener("click", () => {
        localStorage.setItem("FieldType", "Variables");
        Table(VariableUI);
    });
    ...
    divchild2.style.cursor = "pointer";

    let img1 = document.createElement("img");
    img1.className = "";
    img1.setAttribute("draggable", false);
    img1.setAttribute("src", `data:image/png;base64,` + $Document);
    img1.style.width = "18px";
    img1.style.height = "18px";
    divchild2.appendChild(img1);

    let likn2 = document.createElement("span");
    likn2.textContent = mxResources.get("Process_output_documentation");
    likn2.className = "span";
    likn2.setAttribute("changeLang", "Process_output_documentation");

    divchild2.appendChild(likn2);

    //_JsonVariable get by Process.js
    divchild2.addEventListener("click", () => {
        localStorage.setItem("FieldType", "DocumentUI");
        Table(DocumentUI);
    });
    div.appendChild(divchild2);

    var fns = [div];
    this.addCostumPaletteFunctions("Settings", "Settings", false, fns);
    this.setCurrentSearchEntryLibrary();
};
...
Sidebar.prototype.createTitle = function (label) {
    ...
    elt.setAttribute("titleLang", "sidebarTooltip");
    elt.className = "geTitle";

    let img = document.createElement("img");
    img.src = "data:image/png;base64," + $ImgProcess[count];
    ...
    mxUtils.write(span, mxResources.get(label));
    span.style.margin = "0px 5px";
    elt.appendChild(span);

    let i = document.createElement("i");
    _Lang == "Fa"
        ? (i.className = `fa fa-angle-left pull-right rotate ${
            count == 0 ? "fa-rotate-90" : ""
            }`)
        : (i.className = `fa fa-angle-right pull-left rotate ${
            count == 0 ? "fa-rotate-90" : ""
            }`);
...
Sidebar.prototype.addCostumPaletteFunctions = function (
    id,
    title,
    expanded,
    fns
...
Sidebar.prototype.addFoldingHandler = function (title, content, funct) {
    ...
    mxEvent.addListener(
        ...
        "click",
        mxUtils.bind(this, function (evt) {
            title.children[2].classList.toggle("fa-rotate-90");
            title.classList.add("current");
            $(`.geTitle:not('.current') i:not(:first)`).removeClass("fa-rotate-90");
            title.classList.remove("current");

            $(`.geSidebar:first`).addClass("currentContent");
            content.classList.add("currentContent");
            $(`.geSidebar`)
                .not(".currentContent")
                .not(":first")
                .css("display", "none");
            content.classList.remove("currentContent");
            const rgba2hex = (rgba) =>
                `#${rgba
            ...
            if (_Lang == "Fa") {
                ...
                title.style.borderLeft = `3px solid ${rgba2hex(
                    $("#geTitleChecked").css("color")
                )}`;
            } else {
                $(`.geTitle`).css("border-right", "3px solid #2a3f54");
                title.style.borderRight = `3px solid${rgba2hex(
                    $("#geTitleChecked").css("color")
                )}`;
            }
