 ...
 */
Menus.prototype.defaultFont = "IRANSansWeb";
        ...
        new Menu(
            mxUtils.bind(this, function (menu, parent) {
                var addItem = mxUtils.bind(this, function (fontname) {
                    ...
                    tr.firstChild.nextSibling.style.fontFamily = "Tahoma";
                });
...
Menus.prototype.addShortcut = function (item, action) {
    if (action.shortcut != null) {
        var td;
        if (item.firstChild.nextSibling.nextSibling != null)
            td = item.firstChild.nextSibling.nextSibling;
...
Menus.prototype.addPopupMenuEditItems = function (menu, cell, evt) {
    if (this.editorUi.editor.graph.isSelectionEmpty()) {
        ...
        const type = getType(cell.style);
        if (type == "Inclusive Gateway" || type == "Exclusive Gateway") {
            localStorage.setItem("Gateway", cell.id);
            this.addMenuItems(
                menu,
                ["delete", "cut", "copy", "-", "conditions"],
                null,
                evt
            );
            ...
            this.addMenuItems(
                menu,
                ["delete", "cut", "copy", "-", "TimerStart", "-", "lockUnlock"],
                null,
                evt
            );
        } else if (type == "IntermediateTimerEvent") {
            this.addMenuItems(
                menu,
                ["delete", "cut", "copy", "-", "IntermediateTimer", "-", "lockUnlock"],
                null,
                evt
            );
            ...
            this.addMenuItems(
                menu,
                ["delete", "cut", "copy", "-", "eventSetting", "-", "lockUnlock"],
                null,
                evt
            );
        } else {
...
Menus.prototype.addPopupMenuArrangeItems = function (menu, cell, evt) {
    ...
    //   graph.getModel().getChildCount(cell) > 1
    // ) {
