...
/* Release Ferdos.WebAppDesk 3.5.1.0*/
/* Release Ferdos.BPMS*/
  ...
  if (!graph.standalone) {
    ...
    if (this.toolbar != null) {
      var update = mxUtils.bind(this, function () {
        var ff = graph.currentVertexStyle["fontFamily"] || "IRANSansWeb";
...
/**
 * Specifies the width of the format panel. Default is 230.
 */
EditorUi.prototype.formatWidth = 230;
 ...
 */
EditorUi.prototype.footerHeight = 40;

/**
 * Specifies the height of the optional sidebarFooterContainer. Default is 34.
 */
EditorUi.prototype.sidebarFooterHeight = 50;
...
EditorUi.prototype.getCellsForShapePicker = function (cell) {
  ...
  return [
    ...
    // this.addEntry(
    //   this.getTagsForStencil("mxgraph.bpmn", "").join(" "),
    //   function () {
    //     var cell = new mxCell(
    //       "",
    //       new mxGeometry(0, 0, 150, 70),
    //       "html=1;whiteSpace=wrap;rounded=1;dropTarget=0;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;gradientColor=#ebf4ff;",
    //       "UserTask"
    //     );
    //     cell.vertex = true;
    ...
    //       "html=1;shape=mxgraph.bpmn.user_task;outlineConnect=0;strokeWidth=2;fillColor=#f9fdfe;strokeColor=#156c7d;"
    //     );
    //     cell1.vertex = true;
  ...
  if (this.editor.isChromelessView()) {
    ...
    if (urlParams["toolbar"] != "0") {
      ...
      if (this.isPagesEnabled()) {
        ...
        pageInfo.style.fontFamily = "IRANSansWeb,Arial";
        ...
        var layersButton = addButton(
          mxUtils.bind(this, function (evt) {
            if (this.layersDialog != null) {
              ...
              this.layersDialog.style.fontFamily = "IRANSansWeb,Arial";
...
EditorUi.prototype.toggleFormatPanel = function (visible) {
  ...
  if (this.format != null) {
    this.formatWidth = visible ? 230 : 0;
...
EditorUi.prototype.addUndoListener = function () {
  ...
  var undoListener = mxUtils.bind(this, function () {
    undo.setEnabled(
      Object.keys(this.editor.graph.getModel().cells).length > 2
        ? this.canUndo()
        : false
    );
...
EditorUi.prototype.refresh = function (sizeDidChange) {
  ...
  if (this.menubar != null) {
    // this.menubarContainer.style.height = "40px";
  }

  if (this.toolbar != null) {
    this.toolbarContainer.style.height = "0px";
  ...
  this.sidebarContainer.style.top = "50px";
  this.sidebarContainer.style.width = "230px";
  this.formatContainer.style.top = "97px";
  ...
  // this.diagramContainer.style.left = "230px";
  this.diagramContainer.style.top = "97px";
  // this.diagramContainer.style.border = "1px solid #ccc";
  ...
  if (quirks) {
    ...
    // this.diagramContainer.style.right = "230px";
    var th = 0;
    ...
    this.sidebarContainer.style.bottom = sidebarFooterHeight + off + "px";
    this.formatContainer.style.bottom = this.footerHeight + off + "px";
    this.diagramContainer.style.bottom = this.footerHeight + off + th + "px";

    this.footerContainer.style.right =
      +this.formatContainer.style.width.replace("px", "") +
      +this.diagramContainer.style.width.replace("px", "") +
      "px";
  }
...
EditorUi.prototype.createDivs = function () {
  this.menubarContainer = document.getElementById(header);
  this.toolbarContainer = this.createDiv("geToolbarContainer");
  this.sidebarContainer = this.createDiv("geSidebarContainer");
  this.formatContainer = this.createDiv(
    "geSidebarContainer geFormatContainer formatClicked"
  );
  ...
  this.sidebarContainer.style.direction = "rtl";
  this.sidebarContainer.style.width = "230px";
  this.formatContainer.style.zIndex = "1";
  this.formatContainer.style.border = "1px solid #ccc";
  this.formatContainer.style.backgroundColor = "#ffffff";
  if (_Lang == "Fa") {
  ...
  this.formatContainer.style.direction = "ltr";
...
EditorUi.prototype.createUi = function () {
  ...
  //create btn resive and send toolbar
  // if (this.toolbar != null) {
  //   let toolbtn_send = document.createElement("button");
  //   toolbtn_send.className = "btn btn-success btnsend";
  //   toolbtn_send.addEventListener("click", () => {
  //     Export();
  //   });
  //   this.toolbarContainer.appendChild(toolbtn_send);
  //   this.container.appendChild(this.toolbarContainer);
  //   let toolbtn_resive = document.createElement("button");
  //   toolbtn_resive.className = "btn btn-success btnresive";
  //   toolbtn_resive.addEventListener("click", () => {
  //     Import();
  //   });
  //   this.toolbarContainer.appendChild(toolbtn_resive);
  //   this.container.appendChild(this.toolbarContainer);
  // }
...
EditorUi.prototype.createFooter = function () {
  return this.createDiv("geFooter", "Footer");
};
...
EditorUi.prototype.createDiv = function (classname, id) {
  ...
  if (id == "Footer") {
    elt.className = classname + " col-md-12";
    let DivFoot = document.createElement("div");
    DivFoot.className = "row";
    let copyright = document.createElement("div");
    _Lang == "Fa"
      ? (copyright.className = "pull-left col-md-10")
      : (copyright.className = "pull-right col-md-10");
    let spanCopy = document.createElement("span");
    let a = document.createElement("a");
    a.href = "https://amnpardaz.com";
    a.id = "copyRightLabel";
    a.target = "_blank";
    a.textContent = mxResources.get("copyright");

    spanCopy.appendChild(a);
    copyright.appendChild(spanCopy);
    DivFoot.appendChild(copyright);

    let version = document.createElement("div");
    if (_Lang == "Fa") {
      version.className = "pull-right col-md-2";
      version.style.display = "flex";
      version.style.justifyContent = "left";
    } else {
      version.className = "pull-left col-md-2";
      version.style.display = "flex";
      version.style.justifyContent = "right";
    }
    let spanversion = document.createElement("span");
    spanversion.id = "versionLabel";
    spanversion.innerHTML = _Version;
    version.appendChild(spanversion);
    DivFoot.appendChild(version);

    elt.appendChild(DivFoot);
  }
  return elt;
};
