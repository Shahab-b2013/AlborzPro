...
(function (a) {
  ...
  function E(a, w, t, D) {
    a.hasOwnProperty(w) || (a[w] = D.apply(null, t));
  }
  a = a ? a._modules : {};
  E(
    a,
    ...
    function (a, w) {
      ...
      function F(d, c, b, f) {
        var k = c.options.chart.options3d,
          a = x(f, b ? c.inverted : !1),
          e = {
            x: c.plotWidth / 2,
            y: c.plotHeight / 2,
            z: k.depth / 2,
            vd: x(k.depth, 1) * x(k.viewDistance, 0),
          },
          n = c.scale3d || 1;
        f = l * k.beta * (a ? -1 : 1);
        k = l * k.alpha * (a ? -1 : 1);
        ...
        return d.map(function (b) {
          ...
          d.y = d.y * n + e.y;
          d.z = c.z * n + e.z;
          return { x: a ? d.y : d.x, y: a ? d.x : d.y, z: d.z };
        });
      }
      function f(d, c) {
        ...
        return Math.sqrt(
          Math.pow(f - x(d.plotX, d.x), 2) +
            Math.pow(c - x(d.plotY, d.y), 2) +
            Math.pow(b - x(d.plotZ, d.z), 2)
        );
      }
      function z(d) {
        var c = 0,
          ...
          base: {
            initArgs: function (f) {
              ...
              d.parts.forEach(function (f) {
                d[f] = c
                  .path(b[f])
                  .attr({ class: "highcharts-3d-" + f, zIndex: a[f] || 0 })
                  .add(d);
              });
              d.attr({ "stroke-linejoin": "round", zIndex: a.group });
              d.originalDestroy = d.destroy;
              d.destroy = d.destroyParts;
              d.forcedSides = b.forcedSides;
            },
            singleSetterForParts: function (f, d, c, b, a, k) {
              var l = {};
              b = [null, null, b || "attr", a, k];
              var e = c && c.zIndexes;
              c
      ...
      x.cuboid = a(x.base, {
        ...
        animate: function (a, d, c) {
          if (f(a.x) && f(a.y)) {
            ...
            b !== this.forcedSides &&
              ((this.forcedSides = b),
              x.cuboid.fillSetter.call(this, this.fill));
  ...
  E(
    ...
    function (a, w, t, D, f, z, v, x) {
      ...
      return (function (a) {
        ...
        m.curveTo = function (b, e, h, r, g, y, I, d) {
          var c = [],
            a = y - g;
          return y > g && y - g > Math.PI / 2 + 0.0001
            ? ((c = c.concat(
                this.curveTo(b, e, h, r, g, g + Math.PI / 2, I, d)
              )),
              (c = c.concat(
                this.curveTo(b, e, h, r, g + Math.PI / 2, y, I, d)
              )))
            : y < g && g - y > Math.PI / 2 + 0.0001
            ? ((c = c.concat(
                this.curveTo(b, e, h, r, g, g - Math.PI / 2, I, d)
              )),
              (c = c.concat(
            ...
            : [
                [
                  "C",
                  b + h * Math.cos(g) - h * B * a * Math.sin(g) + I,
                  e + r * Math.sin(g) + r * B * a * Math.cos(g) + d,
                  b + h * Math.cos(y) + h * B * a * Math.sin(y) + I,
                  e + r * Math.sin(y) - r * B * a * Math.cos(y) + d,
                  b + h * Math.cos(y) + I,
                  e + r * Math.sin(y) + d,
                ],
              ];
        ...
        m.prototype.face3d = function (d) {
          ...
          h.attr = function (h) {
            if (
              "object" === typeof h &&
              (e(h.enabled) || e(h.vertexes) || e(h.insidePlotArea))
            ) {
              this.enabled = q(h.enabled, this.enabled);
              this.vertexes = q(h.vertexes, this.vertexes);
              this.insidePlotArea = q(h.insidePlotArea, this.insidePlotArea);
              delete h.enabled;
              delete h.vertexes;
              delete h.insidePlotArea;
              var g = k(this.vertexes, b[c.chartIndex], this.insidePlotArea),
                y = c.toLinePath(g, !0);
              g = A(g);
              h.d = y;
        ...
        m.prototype.polyhedron = function (b) {
          var d = this,
            h = this.g(),
            r = h.destroy;
          this.styledMode || h.attr({ "stroke-linejoin": "round" });
          h.faces = [];
          h.destroy = function () {
            for (var b = 0; b < h.faces.length; b++) h.faces[b].destroy();
            return r.call(this);
          };
          h.attr = function (b, y, r, c) {
            if ("object" === typeof b && e(b.faces)) {
              for (; h.faces.length > b.faces.length; ) h.faces.pop().destroy();
              for (; h.faces.length < b.faces.length; )
                h.faces.push(d.face3d().add(h));
              for (var g = 0; g < b.faces.length; g++)
                d.styledMode && delete b.faces[g].fill,
                  h.faces[g].attr(b.faces[g], null, r, c);
              delete b.faces;
            }
            return f.prototype.attr.apply(this, arguments);
          };
          h.animate = function (b, e, r) {
            if (b && b.faces) {
              ...
              for (; h.faces.length < b.faces.length; )
                h.faces.push(d.face3d().add(h));
              for (var g = 0; g < b.faces.length; g++)
                h.faces[g].animate(b.faces[g], e, r);
              delete b.faces;
            }
            return f.prototype.animate.apply(this, arguments);
          };
        ...
        m.prototype.cuboidPath = function (e) {
          function d(b) {
            return 0 === c && 1 < b && 6 > b
              ? { x: m[b].x, y: m[b].y + 10, z: m[b].z }
              : m[0].x === m[7].x && 4 <= b
              ? { x: m[b].x + 10, y: m[b].y, z: m[b].z }
              : (0 === n && 2 > b) || 5 < b
              ? { x: m[b].x, y: m[b].y, z: m[b].z + 10 }
              : m[b];
          }
          function h(b) {
            return m[b];
          ...
          var r = e.x || 0,
            ...
            n = e.depth || 0,
            f = b[this.chartIndex],
            q = f.options.chart.options3d.alpha,
            u = 0,
            m = [
              { x: r, y: g, z: y },
              { x: r + a, y: g, z: y },
          ...
          var J = function (b, g, e) {
            ...
            0 > A(r)
              ...
              : e &&
                (C.push(e),
                (y = 0 > A(b) ? [r, 0] : 0 > A(g) ? [c, 1] : [r, 0]));
            return y;
          };
          var p = J([3, 2, 1, 0], [7, 6, 5, 4], "front");
          e = p[0];
          var G = p[1];
          p = J([1, 6, 7, 0], [4, 5, 2, 3], "top");
          a = p[0];
          var l = p[1];
          p = J([1, 2, 5, 6], [0, 7, 4, 3], "side");
          J = p[0];
          p = p[1];
          1 === p ? (u += 1e6 * (f.plotWidth - r)) : p || (u += 1e6 * r);
          u +=
            10 *
            (!l || (0 <= q && 180 >= q) || (360 > q && 357.5 < q)
              ? f.plotHeight - g
              : 10 + g);
        ...
        m.prototype.arc3d = function (b) {
          function e(b) {
            ...
            b = u(b);
            for (y in b)
              -1 !== g.indexOf(y) && ((e[y] = b[y]), delete b[y], (h = !0));
            return h ? [e, b] : !1;
          }
          var h = this.g(),
            r = h.renderer,
          ...
          h.onAdd = function () {
            ...
            ["out", "inn", "side1", "side2"].forEach(function (g) {
              h[g].attr({ class: e + " highcharts-3d-side" }).add(b);
            });
          };
          ...
          h.setPaths = function (b) {
            var e = h.renderer.arc3dPath(b),
              g = 100 * e.zTop;
            h.attribs = b;
            h.top.attr({ d: e.top, zIndex: e.zTop });
            h.inn.attr({ d: e.inn, zIndex: e.zInn });
            h.out.attr({ d: e.out, zIndex: e.zOut });
            h.side1.attr({ d: e.side1, zIndex: e.zSide1 });
            h.side2.attr({ d: e.side2, zIndex: e.zSide2 });
            h.zIndex = g;
            h.attr({ zIndex: g });
          ...
          h.animate = function (b, g, r) {
            ...
            delete b.alpha;
            delete b.beta;
            var a = d(q(g, this.renderer.globalAnimation));
            if (a.duration) {
              g = e(b);
              h[c] = 0;
              b[c] = 1;
              ...
              if (g) {
                ...
                a.step = function (b, e) {
                  function g(b) {
                    return y[b] + (q(n[b], y[b]) - y[b]) * e.pos;
                  }
                  e.prop === c &&
                    e.elem.setPaths(
                      u(y, {
        ...
        m.prototype.arc3dPath = function (b) {
          ...
          var B = n * Math.sin(f);
          n = [["M", h + l * u, r + d * p]];
          n = n.concat(m.curveTo(h, r, l, d, g, c, 0, 0));
          n.push(["L", h + A * b, r + v * k]);
          n = n.concat(m.curveTo(h, r, A, v, c, g, 0, 0));
          n.push(["Z"]);
          var z = 0 < q ? Math.PI / 2 : 0;
          q = 0 < f ? 0 : Math.PI / 2;
          z = g > -z ? g : c > -z ? -z : g;
          var t = c < H - q ? c : g < H - q ? H - q : c,
            x = 2 * H - q;
          f = [["M", h + l * G(z), r + d * C(z)]];
          f = f.concat(m.curveTo(h, r, l, d, z, t, 0, 0));
          c > x && g < x
            ? (f.push(["L", h + l * G(t) + a, r + d * C(t) + B]),
              (f = f.concat(m.curveTo(h, r, l, d, t, x, a, B))),
              f.push(["L", h + l * G(x), r + d * C(x)]),
              (f = f.concat(m.curveTo(h, r, l, d, x, c, 0, 0))),
              f.push(["L", h + l * G(c) + a, r + d * C(c) + B]),
              (f = f.concat(m.curveTo(h, r, l, d, c, x, a, B))),
              f.push(["L", h + l * G(x), r + d * C(x)]),
              (f = f.concat(m.curveTo(h, r, l, d, x, t, 0, 0))))
            : c > H - q &&
              g < H - q &&
              (f.push(["L", h + l * Math.cos(t) + a, r + d * Math.sin(t) + B]),
              (f = f.concat(m.curveTo(h, r, l, d, t, c, a, B))),
              f.push(["L", h + l * Math.cos(c), r + d * Math.sin(c)]),
              (f = f.concat(m.curveTo(h, r, l, d, c, t, 0, 0))));
          f.push(["L", h + l * Math.cos(t) + a, r + d * Math.sin(t) + B]);
          f = f.concat(m.curveTo(h, r, l, d, t, z, a, B));
          f.push(["Z"]);
          q = [["M", h + A * u, r + v * p]];
          q = q.concat(m.curveTo(h, r, A, v, g, c, 0, 0));
          q.push(["L", h + A * Math.cos(c) + a, r + v * Math.sin(c) + B]);
          q = q.concat(m.curveTo(h, r, A, v, c, g, a, B));
          q.push(["Z"]);
          u = [
            ["M", h + l * u, r + d * p],
            ["L", h + l * u + a, r + d * p + B],
    ...
    function (a, w, t, D) {
      ...
      (function (a) {
        ...
        function n() {
          if (this.chart3d && this.is3d()) {
            var b = this.renderer,
              ...
              a = this.plotTop,
              q = this.plotTop + this.plotHeight;
            e = e.depth;
            var n = c - (g.left.visible ? g.left.size : 0),
              u = d + (g.right.visible ? g.right.size : 0),
              m = a - (g.top.visible ? g.top.size : 0),
              k = q + (g.bottom.visible ? g.bottom.size : 0),
              p = 0 - (g.front.visible ? g.front.size : 0),
        ...
        function u() {
          this.styledMode &&
            ...
            [
              ...
              this.renderer.definition({
                tagName: "filter",
                attributes: { id: "highcharts-" + b.name },
                children: [
                  {
                    ...
                    children: [
                      {
                        tagName: "feFuncR",
                        attributes: { type: "linear", slope: b.slope },
                      },
                      {
                        tagName: "feFuncG",
                        attributes: { type: "linear", slope: b.slope },
        ...
        function q() {
          ...
          this.is3d() &&
            (b.series || []).forEach(function (e) {
              "scatter" ===
                (e.type || b.chart.type || b.chart.defaultSeriesType) &&
                (e.type = "scatter3d");
            });
        }
        function k() {
          ...
          if (this.chart3d && this.is3d()) {
            b &&
              ((b.alpha = (b.alpha % 360) + (0 <= b.alpha ? 0 : 360)),
              (b.beta = (b.beta % 360) + (0 <= b.beta ? 0 : 360)));
            var e = this.inverted,
              g = this.clipBox,
              c = this.margin;
            g[e ? "y" : "x"] = -(c[3] || 0);
            g[e ? "x" : "y"] = -(c[0] || 0);
            g[e ? "height" : "width"] =
              this.chartWidth + (c[3] || 0) + (c[1] || 0);
            g[e ? "width" : "height"] =
              this.chartHeight + (c[0] || 0) + (c[2] || 0);
            this.scale3d = 1;
            !0 === b.fitToPlot &&
              (this.scale3d = this.chart3d.getScale(b.depth));
        ...
        function t(b) {
          ...
          if (this.is3d())
            for (; e--; ) (b = this.series[e]), b.translate(), b.render();
          else b.call(this);
        }
        function w(b) {
        ...
        var F = (function () {
          ...
          e.prototype.get3dFrame = function () {
            var e = this.chart,
              ...
              h = e.plotTop,
              q = e.plotTop + e.plotHeight,
              n = g.depth,
              f = function (b) {
                b = v(b, e);
                return 0.5 < b ? 1 : -0.5 > b ? -1 : 0;
              },
              u = f([
                { x: d, y: q, z: n },
                { x: a, y: q, z: n },
            ...
            var t = function (e, c, d) {
              for (
                var g = ["size", "color", "visible"], a = {}, q = 0;
                q < g.length;
                q++
              )
            ...
            c = {
              ...
              right: t([c.right, c.left, c.side, c], p, A),
            ...
            "auto" === g.axisLabelPosition
              ? ((p = function (b, e) {
                  return (
                    b.visible !== e.visible ||
                    (b.visible && e.visible && b.frontFacing !== e.frontFacing)
                  );
                }),
                (g = []),
                p(c.left, c.front) &&
                ...
                (d = function (b, c, d) {
                  ...
                  for (var g = z(b, e, !1), a = 0, q = 1; q < g.length; q++)
                    d * g[q][c] > d * g[a][c]
                      ? (a = q)
                      : d * g[q][c] === d * g[a][c] &&
                        g[q].z < g[a].z &&
                ...
                (c.axes = {
                  y: { left: d(g, "x", -1), right: d(g, "x", 1) },
                  x: { top: d(m, "y", -1), bottom: d(u, "y", 1) },
                  z: { top: d(q, "y", -1), bottom: d(k, "y", 1) },
                }))
              : (c.axes = {
                  y: {
                  ...
                  x: {
                    top: { y: h, z: 0, xDir: { x: 1, y: 0, z: 0 } },
                    bottom: { y: q, z: 0, xDir: { x: 1, y: 0, z: 0 } },
                  },
                  z: {
                    top: {
                      x: B ? a : d,
                      y: h,
                      xDir: B ? { x: 0, y: 0, z: 1 } : { x: 0, y: 0, z: -1 },
                    },
                    bottom: {
                      x: B ? a : d,
                      y: q,
          ...
          e.prototype.getScale = function (b) {
            ...
            [0, 1].forEach(function (b) {
              l.push({ x: d, y: l[b].y, z: l[b].z });
            });
            [0, 1, 2, 3].forEach(function (b) {
              l.push({ x: l[b].x, y: q, z: l[b].z });
            });
            l = z(l, e, !1);
            ...
            a > m &&
              (k =
                0 > m
                  ? Math.min(k, (a + n) / (-m + a + n))
                  : Math.min(k, 1 - (((a + n) / (m + n)) % 1)));
            q < p && (k = Math.min(k, Math.abs((q - n) / (p - n))));
            return k;
          };
          return e;
        })();
        ...
        a.compose = function (b, f) {
          ...
          f.matrixSetter = function () {
            if (1 > this.pos && (d(this.start) || d(this.end))) {
              ...
              var c = [];
              for (var a = 0; 6 > a; a++)
                c.push(this.pos * e[a] + (1 - this.pos) * b[a]);
            } else c = this.end;
          ...
          l(b, "init", B);
          l(b, "addSeries", e);
          l(b, "afterDrawChartBox", n);
          l(b, "afterGetContainer", u);
          l(b, "afterInit", q);
          l(b, "afterSetChartSize", k);
          l(b, "beforeRedraw", C);
          l(b, "beforeRender", A);
          p(g, "isInsidePlot", m);
          p(b, "renderSeries", t);
      ...
      var t =
        ...
        l = (function (a) {
          ...
          c.prototype.setAxisSize = function () {
            ...
            this.width = this.len =
              (b.options.chart.options3d && b.options.chart.options3d.depth) ||
              0;
            this.right = b.chartWidth - this.width - this.left;
          };
          c.prototype.setOptions = function (b) {
            b = f({ offset: 0, lineWidth: 0 }, b);
            this.isZAxis = !0;
      ...
      a.wrapGetMarkPath = function (a) {
        ...
        if (f) {
          ...
          if ("M" === l[0] && "L" === d[0])
            return (
              (f = [
                f.fix3dPosition({ x: l[1], y: l[2], z: 0 }),
                f.fix3dPosition({ x: d[1], y: d[2], z: 0 }),
              ]),
    ...
    function (a, w, t, D, f) {
        ...
        k = (function () {
          ...
          c.prototype.fix3dPosition = function (e, c) {
            ...
            var k = d.chart3d.frame3d,
              ...
              r = { x: 0, y: 1, z: 0 },
              g = !1;
            e = a.axis3D.swapZ({ x: e.x, y: e.y, z: 0 });
            if (a.isZAxis)
              if (a.opposite) {
                ...
                h = e.y - x;
                e.x = k.axes.z.bottom.x;
                e.y = k.axes.z.bottom.y;
                m = k.axes.z.bottom.xDir;
                g = !k.bottom.frontFacing;
              }
            else if (a.horiz)
              if (a.opposite) {
                ...
                h = e.y - x;
                e.y = k.axes.x.bottom.y;
                e.z = k.axes.x.bottom.z;
                m = k.axes.x.bottom.xDir;
                g = !k.bottom.frontFacing;
              }
            else if (a.opposite) {
              if (null === k.axes.y.right) return {};
              d = e.x - t;
              e.x = k.axes.y.right.x;
              e.z = k.axes.y.right.z;
              m = k.axes.y.right.xDir;
              m = { x: m.z, y: m.y, z: -m.x };
            } else {
              ...
              ("flap" === p
                ? a.horiz
                  ? ((f = Math.sin(n)),
                    ...
                    a.opposite && (f = -f),
                    g && (f = -f),
                    (r = { x: m.z * f, y: n, z: -m.x * f }))
                  : (m = { x: Math.cos(f), y: 0, z: Math.sin(f) })
                : "ortho" === p
                ? a.horiz
                  ? ((r = Math.cos(n)),
                    (p = Math.sin(f) * r),
                    ...
                    (n = 1 / Math.sqrt(r.x * r.x + r.y * r.y + r.z * r.z)),
                    g && (n = -n),
                    (r = { x: n * r.x, y: n * r.y, z: n * r.z }))
                  : (m = { x: Math.cos(f), y: 0, z: Math.sin(f) })
                : a.horiz
                ? (r = {
            ...
            c &&
              (0 >
                l(
                  v(
                    [
                      e,
                      { x: e.x + m.x, y: e.y + m.y, z: e.z + m.z },
                      { x: e.x + r.x, y: e.y + r.y, z: e.z + r.z },
                    ],
                    a.chart
                  )
                ) && (m = { x: -m.x, y: -m.y, z: -m.z }),
              ...
              (d.matrix[4] -= d.x * d.matrix[0] + d.y * d.matrix[2]),
              (d.matrix[5] -= d.x * d.matrix[1] + d.y * d.matrix[3]));
            return d;
          };
          c.prototype.swapZ = function (b, a) {
            var e = this.axis;
            return e.isZAxis
              ? ((a = a ? 0 : e.chart.plotLeft),
      ...
      return (function () {
        ...
        a.compose = function (b) {
          ...
          b = b.prototype;
          p(b, "getLinePath", a.wrapGetLinePath);
          p(b, "getPlotBandPath", a.wrapGetPlotBandPath);
          p(b, "getPlotLinePath", a.wrapGetPlotLinePath);
          p(b, "getSlotWidth", a.wrapGetSlotWidth);
          p(b, "getTitlePosition", a.wrapGetTitlePosition);
          D.compose(t);
        };
        a.onAfterSetOptions = function () {
          ...
          a.is3d &&
            a.is3d() &&
            "colorAxis" !== this.coll &&
            ((c.tickWidth = b(c.tickWidth, 0)),
            (c.gridLineWidth = b(c.gridLineWidth, 1)));
        };
        a.onDrawCrosshair = function (b) {
          this.chart.is3d() &&
            "colorAxis" !== this.coll &&
            b.point &&
            (b.point.crosshairPos = this.isXAxis
              ? b.point.axisXpos
              : this.len - b.point.axisYpos);
        };
        a.onInit = function () {
        ...
        a.wrapGetPlotBandPath = function (b) {
          ...
          var a = arguments,
            c = a[2],
            e = [];
          a = this.getPlotLinePath({ value: a[1] });
          c = this.getPlotLinePath({ value: c });
          if (a && c)
        ...
        a.wrapGetPlotLinePath = function (b) {
          ...
          "M" === k[0] &&
            "L" === p[0] &&
            ((a = [
              a.swapZ({ x: k[1], y: k[2], z: 0 }),
              a.swapZ({ x: k[1], y: k[2], z: f }),
              a.swapZ({ x: p[1], y: p[2], z: 0 }),
              a.swapZ({ x: p[1], y: p[2], z: f }),
            ]),
            this.horiz
              ? (this.isZAxis
                  ? (d.left.visible && e.push(a[0], a[2]),
                    d.right.visible && e.push(a[1], a[3]))
                  : (d.front.visible && e.push(a[0], a[2]),
                    d.back.visible && e.push(a[1], a[3])),
                d.top.visible && e.push(a[0], a[1]),
                d.bottom.visible && e.push(a[2], a[3]))
              : (d.front.visible && e.push(a[0], a[2]),
                d.back.visible && e.push(a[1], a[3]),
                d.left.visible && e.push(a[0], a[1]),
                d.right.visible && e.push(a[2], a[3])),
            (e = v(e, this.chart, !1)));
        ...
        a.wrapGetSlotWidth = function (a, c) {
          ...
          if (
            ...
            var n = e.frameShapes.left.getBBox(),
              k = e.options.chart.options3d;
            e = {
              x: e.plotWidth / 2,
              y: e.plotHeight / 2,
              z: k.depth / 2,
              vd: b(k.depth, 1) * b(k.viewDistance, 0),
            };
            k = c.pos;
            var p = d[k - 1],
              m = d[k + 1],
            ...
            0 !== k &&
              ...
              p.label &&
              p.label.xy &&
              (d = x({ x: p.label.xy.x, y: p.label.xy.y, z: null }, e, e.vd));
            m &&
              m.label &&
              m.label.xy &&
              (l = x({ x: m.label.xy.x, y: m.label.xy.y, z: null }, e, e.vd));
            k = { x: c.label.xy.x, y: c.label.xy.y, z: null };
            k = x(k, e, e.vd);
            return Math.abs(d ? k.x - d.x : l ? l.x - k.x : f.x - n.x);
          }
  ...
  E(
    ...
    function (a, w, t) {
      ...
      t = (function (a) {
        ...
        c.prototype.translate3dPoints = function () {
          var b = this.options,
            ...
            n = [];
          this.zPadding =
            (b.stacking ? (l(b.stack) ? b.stack : 0) : this.index || 0) *
            (b.depth || 0 + (b.groupZPadding || 1));
          for (e = 0; e < this.data.length; e++) {
            ...
            b.axisYpos = b.plotY;
            b.axisZpos = b.plotZ;
            d.push({ x: b.plotX, y: b.plotY, z: b.plotZ });
            n.push(b.plotX || 0);
          }
          this.rawPointsX = n;
          a = f(d, a, !0);
      ...
      z(w.prototype, { translate3dPoints: t.prototype.translate3dPoints });
      return t;
    }
  );
  E(
    ...
    function (a, w, t, D, f, z, v) {
      ...
      function l(b) {
        ...
        this.chart.is3d &&
          ...
          (a["stroke-width"] = A(this.options.edgeWidth, 1)));
        return a;
      }
      function d(b, a, c) {
      ...
      b.translate3dShapes = function () {
        var b = this,
          ...
          d = c.depth,
          f =
            (c.stacking ? c.stack || 0 : b.index) *
            (d + (c.groupZPadding || 1)),
          p = b.borderWidth % 2 ? 0.5 : 0,
          l;
        ...
        b.data.forEach(function (c) {
          ...
          if (null !== c.y) {
            ...
            [
              ...
              q = e[a[0]] - p;
              0 > q && ((e[a[1]] += e[a[0]] + p), (e[a[0]] = -p), (q = 0));
              q + e[a[1]] > b[a[0] + "Axis"].len &&
                0 !== e[a[1]] &&
                (e[a[1]] = b[a[0] + "Axis"].len - e[a[0]]);
              if (
                0 !== e[a[1]] &&
                (e[a[0]] >= b[a[0] + "Axis"].len || e[a[0]] + e[a[1]] <= p)
              ) {
            ...
            e.depth = d;
            e.insidePlotArea = !0;
            l = { x: e.x + e.width / 2, y: e.y, z: f + d / 2 };
            a.inverted && ((l.x = e.height), (l.y = c.clientX));
            c.plot3d = k([l], a, !0, !1)[0];
            n = k([{ x: n[0], y: n[1], z: f + d / 2 }], a, !0, !1)[0];
          ...
          p &&
            (a
              ? e.data.forEach(function (b) {
                  null !== b.y &&
                    ((b.height = b.shapeArgs.height),
                    (b.shapey = b.shapeArgs.y),
                    (b.shapeArgs.height = 1),
                    d ||
                      (b.shapeArgs.y = b.stackY
              ...
              : (e.data.forEach(function (b) {
                  if (
                    null !== b.y &&
                    ((b.shapeArgs.height = b.height),
                    (b.shapeArgs.y = b.shapey),
                    b.graphic)
                  )
                    b.graphic[b.outside3dPlot ? "attr" : "animate"](
                      b.shapeArgs,
                      e.options.animation
                    );
                }),
        ...
        c.chart.is3d() &&
          c.data.forEach(function (b) {
            b.visible =
              b.options.visible =
              a =
                "undefined" === typeof a ? !A(c.visible, b.visible) : a;
            c.options.data[c.data.indexOf(b)] = b.options;
            b.graphic &&
              b.graphic.attr({ visibility: a ? "visible" : "hidden" });
          });
      ...
      f.seriesTypes.columnRange &&
        ((w = f.seriesTypes.columnrange.prototype),
        v(w, "pointAttribs", l),
        v(w, "setState", d),
        v(w.pointClass.prototype, "hasNewShapeType", c),
        (w.plotGroup = b.plotGroup),
        (w.setVisible = b.setVisible));
      v(t.prototype, "alignDataLabel", function (b, a, c, d, f) {
        ...
        if (e.is3d() && this.is("column")) {
          var p = this.options,
            ...
            q = a.pointWidth / 2 || 0;
          p = { x: f.x + q, y: f.y, z: this.z + p.depth / 2 };
          e.inverted &&
            (l && ((f.width = 0), (p.x += a.shapeArgs.height / 2)),
            90 <= m.alpha && 270 >= m.alpha && (p.y += a.shapeArgs.width));
          p = k([p], e, !0, !1)[0];
          f.x = p.x - q;
          f.y = a.outside3dPlot ? -9e9 : p.y;
        }
        b.apply(this, [].slice.call(arguments, 1));
      });
      v(z.prototype, "getStackBox", function (b, a, c, d, p, l, t, v) {
        ...
        if (a.is3d() && c.base) {
          var q = +c.base.split(",")[0],
            n = a.series[q];
          q = a.options.chart.options3d;
          n &&
            n instanceof f.seriesTypes.column &&
            ((n = {
            ...
            a.inverted &&
              ((e.width = 0), 90 <= q.alpha && 270 >= q.alpha && (n.y += l)),
            (n = k([n], a, !0, !1)[0]),
            (e.x = n.x - l / 2),
            (e.y = n.y));
        }
        ...
        (function () {
          var a = function (f, t) {
            a =
              ...
              function (a, f) {
                for (var l in f) f.hasOwnProperty(l) && (a[l] = f[l]);
              };
            return a(f, t);
          };
          return function (f, t) {
      ...
      t = (function (a) {
        ...
        d.prototype.animate = function (c) {
          if (this.chart.is3d()) {
            ...
            v &&
              (!0 === b && (b = {}),
              c
                ? ((f.oldtranslateX = x(f.oldtranslateX, f.translateX)),
                  (f.oldtranslateY = x(f.oldtranslateY, f.translateY)),
                  (d = {
                    translateX: d[0],
                    translateY: d[1],
                    scaleX: 0.001,
                  ...
                  f.attr(d),
                  l && ((l.attrSetters = f.attrSetters), l.attr(d)))
                : ((d = {
          ...
          if (this.chart.is3d()) {
            ...
            this.data.forEach(function (b) {
              ...
              var e = b.connectorPosition,
                l = -d * (1 - Math.cos((a.alpha || c.alpha) * z)) * Math.sin(f),
        ...
        d.prototype.pointAttribs = function (c) {
          ...
          this.chart.is3d() &&
            ...
            ((b.stroke = d.edgeColor || c.color || this.color),
            (b["stroke-width"] = x(d.edgeWidth, 1)));
          return b;
        };
            ...
            c.data.forEach(function (a) {
              ...
              a.slicedTranslation = {
                translateX: Math.round(
                  Math.cos(f) * b.slicedOffset * Math.cos(l * z)
                ),
                translateY: Math.round(
                  Math.sin(f) * b.slicedOffset * Math.cos(l * z)
                ),
              };
            });
          }
  ...
  E(
    ...
    [a["Series/Scatter/ScatterSeries.js"], a["Core/Utilities.js"]],
    function (a, w) {
      var t =
          (this && this.__extends) ||
          (function () {
      ...
      t(a.area.prototype, "getGraphPath", function (a) {
        ...
        this.group &&
          ...
          (this.markerGroup &&
            ...
            this.markerGroup.attr({ translateX: 0, translateY: 0 })),
          this.group.attr({
            zIndex: Math.max(
              1,
              270 < d.beta || 90 > d.beta
                ? d.depth - Math.round(this.zPadding || 0)
        ...
        this.areaPath &&
          ((c = this.areaPath.splice(0, this.areaPath.length / 2).concat(c)),
          (c.xMap = this.areaPath.xMap),
          (this.areaPath = c),
          l.call(this, b, !1, p));
        return t;
      });
